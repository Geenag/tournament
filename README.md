...
This project was inspired by using the [Ktor Project Generator](https://start.ktor.io).
...
```
cd existing_repo
git remote add origin https://gitlab.ippon.fr/vluce/tournament-2.0.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ippon.fr/vluce/tournament-2.0/-/settings/integrations)
